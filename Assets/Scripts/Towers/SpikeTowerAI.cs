...
public class SpikeTowerAI : MonoBehaviour
{private CircleCollider2D attackRangeCollider;
    ...
    void Update()
    {
        ...
        if (target != null && Time.time - timeSinceLastAttack > attackCooldown)
        {
            Attack(target);
    ...
    void Attack(GameObject target)
    {
        ...
        SpikeProjectile script = projectile.GetComponent<SpikeProjectile>();
